...
GSL_FUN size_t gsl_rstat_n(gsl_rstat_workspace *w);
GSL_FUN int gsl_rstat_add(const double x, gsl_rstat_workspace *w);
GSL_FUN double gsl_rstat_min(gsl_rstat_workspace *w);
GSL_FUN double gsl_rstat_max(gsl_rstat_workspace *w);
GSL_FUN double gsl_rstat_mean(gsl_rstat_workspace *w);
GSL_FUN double gsl_rstat_variance(gsl_rstat_workspace *w);
GSL_FUN double gsl_rstat_sd(gsl_rstat_workspace *w);
GSL_FUN double gsl_rstat_sd_mean(gsl_rstat_workspace *w);
GSL_FUN double gsl_rstat_median(gsl_rstat_workspace *w);
GSL_FUN double gsl_rstat_skew(gsl_rstat_workspace *w);
GSL_FUN double gsl_rstat_kurtosis(gsl_rstat_workspace *w);
